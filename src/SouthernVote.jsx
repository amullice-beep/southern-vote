...
const DMV_OFFICES = {
  ...
  FL: [
    ...
    { name: "DL — Avon Park", addr: "116 E Main St, Avon Park, FL 33825", lat: 27.59554, lon: -81.49970 },
    { name: "DL — Bartow", addr: "430 E Main St, Bartow, FL 33830", lat: 27.89685, lon: -81.83004 },
    { name: "DL — Bell", addr: "1130 S Main St, Bell, FL 32619", lat: 29.75551, lon: -82.86262 },
    { name: "DL — Belle Glade", addr: "2976 State Rd 15, Belle Glade, FL 33430", lat: 26.68451, lon: -80.66756 },
    { name: "DL — Belleview", addr: "10445 SE US Hwy 441, Belleview, FL 34420", lat: 29.06258, lon: -82.04951 },
    { name: "DL — Big Pine Key", addr: "201 Key Deer Blvd, Big Pine Key, FL 33043", lat: 24.67273, lon: -81.35805 },
    { name: "DL — Blountstown", addr: "20859 Central Ave E, Blountstown, FL 32424", lat: 30.44327, lon: -85.04278 },
    ...
    { name: "DL — Bradenton (111th St)", addr: "6007 111th St E, Bradenton, FL 34211", lat: 27.49893, lon: -82.57482 },
    { name: "DL — Bradenton (14th St)", addr: "5756 14th St W, Bradenton, FL 34207", lat: 27.43910, lon: -82.57552 },
    { name: "DL — Bradenton (301 Blvd)", addr: "819 301 Blvd W, Bradenton, FL 34205", lat: 27.46961, lon: -82.56900 },
    { name: "DL — Brandon", addr: "3030 N Falkenburg Rd, Brandon, FL 33511", lat: 27.93780, lon: -82.28592 },
    { name: "DL — Branford", addr: "604 Suwannee Ave, Branford, FL 32008", lat: 29.96257, lon: -82.93090 },
    { name: "DL — Bristol", addr: "10818 NW SR 20, Bristol, FL 32321", lat: 30.43219, lon: -84.97651 },
    { name: "DL — Bronson", addr: "310 School St, Bronson, FL 32621", lat: 29.44751, lon: -82.63436 },
    ...
    { name: "DL — Callahan", addr: "450077 State Rd 200, Callahan, FL 32011", lat: 30.56372, lon: -81.82977 },
    { name: "DL — Callaway", addr: "805 S Tyndall Pkwy, Callaway, FL 32404", lat: 30.13266, lon: -85.59051 },
    { name: "DL — Cape Coral", addr: "1039 SE 9th Ave, Cape Coral, FL 33990", lat: 26.63302, lon: -81.95587 },
    { name: "DL — Carrabelle", addr: "912 NW Ave A, Carrabelle, FL 32322", lat: 29.85288, lon: -84.66656 },
    { name: "DL — Casselberry", addr: "104 Wilshire Blvd, Casselberry, FL 32707", lat: 28.65117, lon: -81.32842 },
    ...
    { name: "DL — Clearwater (Gulf to)", addr: "1663 Gulf to Bay Blvd, Clearwater, FL 33755", lat: 27.96057, lon: -82.76823 },
    { name: "DL — Clearwater (Hwy 19)", addr: "29399 Hwy 19 N, Clearwater, FL 34621", lat: 28.01172, lon: -82.73387 },
    { name: "DL — Clermont", addr: "1505 Hooks St, Clermont, FL 34711", lat: 28.54298, lon: -81.72943 },
    ...
    { name: "DL — Crawfordville", addr: "202 Ochlocknee St, Crawfordville, FL 32327", lat: 30.17604, lon: -84.37518 },
    { name: "DL — Crescent City", addr: "115 N Summit St, Crescent City, FL 32112", lat: 29.43169, lon: -81.51054 },
    { name: "DL — Crestview", addr: "302 N Wilson Blvd, Crestview, FL 32536", lat: 30.76213, lon: -86.57051 },
    { name: "DL — Cross City", addr: "214 NE 351 Hwy, Cross City, FL 32628", lat: 29.72825, lon: -83.00169 },
    { name: "DL — Crystal River", addr: "1540 N Meadowcrest Blvd, Crystal River, FL 34429", lat: 28.90248, lon: -82.59260 },
    { name: "DL — Dade City", addr: "14236 6th Street, Dade City, FL 33523", lat: 28.36547, lon: -82.18814 },
    { name: "DL — Davenport", addr: "2000 Deer Creek Commerce Ln, Davenport, FL 33837", lat: 28.16140, lon: -81.60174 },
    { name: "DL — Daytona Beach", addr: "1845 Holsonback Dr, Daytona Beach, FL 32117", lat: 29.21286, lon: -81.07869 },
    { name: "DL — DeFuniak Springs", addr: "571 US Hwy 90 E, DeFuniak Springs, FL 32433", lat: 30.72102, lon: -86.11522 },
    ...
    { name: "DL — Dunnellon", addr: "19995 SW 86th St, Dunnellon, FL 34431", lat: 29.04914, lon: -82.46093 },
    { name: "DL — Eglin AFB", addr: "310 W Van Matre, Eglin AFB, FL 32542", lat: 30.57770, lon: -86.51396 },
    { name: "DL — Ellenton", addr: "4333 US Hwy 301 N, Ellenton, FL 34222", lat: 27.52624, lon: -82.52146 },
    { name: "DL — Englewood", addr: "6868 San Casa Dr, Englewood, FL 34224", lat: 26.93067, lon: -82.31306 },
    { name: "DL — Everglades City", addr: "102 Copeland Ave N, Everglades City, FL 34139", lat: 25.85748, lon: -81.38496 },
    { name: "DL — Fernandina Beach (Centre St)", addr: "416 Centre St, Fernandina Beach, FL 32034", lat: 30.67100, lon: -81.46188 },
    { name: "DL — Fernandina Beach (License Rd)", addr: "86130 License Rd, Fernandina Beach, FL 32034", lat: 30.67123, lon: -81.46300 },
    ...
    { name: "DL — Fort Myers (Pine Ridge)", addr: "15680 Pine Ridge Rd, Fort Myers, FL 33908", lat: 26.64063, lon: -81.87231 },
    { name: "DL — Fort Myers (S Tamiami)", addr: "18990 S Tamiami Trail, Fort Myers, FL 33908", lat: 26.64063, lon: -81.87231 },
    ...
    { name: "DL — Freeport", addr: "842 State Hwy 20 E, Freeport, FL 32439", lat: 30.49825, lon: -86.13605 },
    ...
    { name: "DL — Gulf Breeze", addr: "5841 Gulf Breeze Pkwy, Gulf Breeze, FL 32563", lat: 30.35832, lon: -87.16571 },
    { name: "DL — Hialeah (NW 138th)", addr: "11093 NW 138th St, Hialeah, FL 33018", lat: 25.89857, lon: -80.37897 },
    { name: "DL — Hialeah (NW 186th)", addr: "6402 NW 186th St, Hialeah, FL 33015", lat: 25.82678, lon: -80.28140 },
    ...
    { name: "DL — Hialeah Gardens", addr: "11920 NW 87 Ct, Hialeah Gardens, FL 33018", lat: 25.86510, lon: -80.32450 },
    { name: "DL — High Springs", addr: "23718 W US Hwy 27, High Springs, FL 32643", lat: 29.83920, lon: -82.60363 },
    { name: "DL — Hilliard", addr: "15885 County Rd 108, Hilliard, FL 32046", lat: 30.69098, lon: -81.91776 },
    ...
    { name: "DL — Homestead", addr: "30708 S Federal Hwy, Homestead, FL 33030", lat: 25.47189, lon: -80.47599 },
    ...
    { name: "DL — Interlachen", addr: "1114 State Rd 20 W, Interlachen, FL 32148", lat: 29.62386, lon: -81.89037 },
    { name: "DL — Inverness", addr: "210 N Apopka Ave, Inverness, FL 34450", lat: 28.83904, lon: -82.33011 },
    { name: "DL — Jacksonville (Atlantic Blvd)", addr: "12220 Atlantic Blvd, Jacksonville, FL 32225", lat: 30.31830, lon: -81.48243 },
    { name: "DL — Jacksonville (E Forsyth)", addr: "231 E Forsyth St, Jacksonville, FL 32202", lat: 30.32673, lon: -81.65417 },
    { name: "DL — Jacksonville (Hogan Rd)", addr: "7120-15 Hogan Rd, Jacksonville, FL 32216", lat: 30.32622, lon: -81.65792 },
    ...
    { name: "DL — Key Largo", addr: "101487 Overseas Hwy, Key Largo, FL 33037", lat: 25.11498, lon: -80.42118 },
    { name: "DL — Key West (N Roosevelt)", addr: "3304 N Roosevelt Blvd, Key West, FL 33040", lat: 24.57222, lon: -81.75637 },
    { name: "DL — Key West (Truman Ave)", addr: "1200 Truman Ave, Key West, FL 33040", lat: 24.55616, lon: -81.79104 },
    { name: "DL — Keystone Heights (SE 8th)", addr: "3979 SE 8th Ave, Keystone Heights, FL 32656", lat: 29.78608, lon: -82.03149 },
    { name: "DL — Keystone Heights (State Rd)", addr: "7380 State Rd 100, Keystone Heights, FL 32656", lat: 29.78608, lon: -82.03149 },
    { name: "DL — Kissimmee (E Irlo)", addr: "2501 E Irlo Bronson Memorial Hwy, Kissimmee, FL 34744", lat: 28.29190, lon: -81.40758 },
    { name: "DL — Kissimmee (S Orange)", addr: "4730 S Orange Blossom Trail, Kissimmee, FL 34746", lat: 28.29190, lon: -81.40758 },
    { name: "DL — Kissimmee (Simpson Rd)", addr: "2595 Simpson Rd, Kissimmee, FL 34744", lat: 28.32144, lon: -81.33803 },
    { name: "DL — Labelle", addr: "25 E Hickpoochee Ave, Labelle, FL 33935", lat: 26.76154, lon: -81.43858 },
    { name: "DL — Lake Alfred", addr: "200 Government Center Blvd, Lake Alfred, FL 33850", lat: 28.09196, lon: -81.72341 },
    ...
    { name: "DL — Lake Wales", addr: "658 Hwy 60 W, Lake Wales, FL 33853", lat: 27.90141, lon: -81.58591 },
    { name: "DL — Lakeland (Florida Ave)", addr: "4130 Florida Ave S, Lakeland, FL 33813", lat: 27.99018, lon: -81.95704 },
    { name: "DL — Lakeland (N Massachusetts)", addr: "916 N Massachusetts Ave, Lakeland, FL 33801", lat: 28.05333, lon: -81.95433 },
    { name: "DL — Land O Lakes", addr: "4135 Land O Lakes Blvd, Land O Lakes, FL 34639", lat: 28.21707, lon: -82.45943 },
    { name: "DL — Largo", addr: "13025 Starkey Rd, Largo, FL 33773", lat: 27.88772, lon: -82.76226 },
    { name: "DL — Lauderdale Lakes", addr: "3718-3 W Oakland Park Blvd, Lauderdale Lakes, FL 33311", lat: 26.16465, lon: -80.21827 },
    { name: "DL — Lauderhill", addr: "1299-A NW 40th Ave, Lauderhill, FL 33313", lat: 26.14036, lon: -80.21338 },
    ...
    { name: "DL — Live Oak", addr: "215 Pine Ave SW, Live Oak, FL 32064", lat: 30.29304, lon: -82.98751 },
    { name: "DL — Loxahatchee", addr: "16440 Town Center Pkwy S, Loxahatchee, FL 33470", lat: 26.68312, lon: -80.25937 },
    ...
    { name: "DL — Madison", addr: "229 SW Pinckney St, Madison, FL 32340", lat: 30.46852, lon: -83.41316 },
    { name: "DL — Marathon", addr: "3015 Overseas Hwy, Marathon, FL 33050", lat: 24.71054, lon: -81.09669 },
    ...
    { name: "DL — Marianna", addr: "4445 E Lafayette St, Marianna, FL 32446", lat: 30.78602, lon: -85.25753 },
    ...
    { name: "DL — Merritt Island", addr: "1605 N Courtenay Pkwy, Merritt Island, FL 32953", lat: 28.38543, lon: -80.70290 },
    { name: "DL — Miami (-K SW)", addr: "13710-K SW 56th St, Miami, FL 33175", lat: 25.77416, lon: -80.19360 },
    ...
    { name: "DL — Miami (NW 27)", addr: "7900 NW 27 Ave, Miami, FL 33147", lat: 25.77416, lon: -80.19360 },
    ...
    { name: "DL — Miami (SW 122)", addr: "14653 SW 122 Ave, Miami, FL 33186", lat: 25.77416, lon: -80.19360 },
    { name: "DL — Miami (SW 147th)", addr: "11735 SW 147th Ave, Miami, FL 33196", lat: 25.65814, lon: -80.43086 },
    ...
    { name: "DL — Miami Beach", addr: "800 71st St, Miami Beach, FL 33141", lat: 25.85582, lon: -80.12620 },
    { name: "DL — Middleburg", addr: "2710 Blanding Blvd, Middleburg, FL 32068", lat: 30.06161, lon: -81.87556 },
    { name: "DL — Milton", addr: "6495 Caroline St, Milton, FL 32570", lat: 30.61783, lon: -87.05087 },
    { name: "DL — Molino", addr: "6440 Hwy 95-A N, Molino, FL 32577", lat: 30.72408, lon: -87.31414 },
    ...
    { name: "DL — Naples (Airport Rd)", addr: "725 Airport Rd S, Naples, FL 34104", lat: 26.14220, lon: -81.79429 },
    { name: "DL — Naples (Collier Blvd)", addr: "6654 Collier Blvd, Naples, FL 34114", lat: 26.14220, lon: -81.79429 },
    { name: "DL — Naples (Collier Blvd) #2", addr: "15450 Collier Blvd, Naples, FL 34120", lat: 26.14220, lon: -81.79429 },
    { name: "DL — Naples (Golden Gate)", addr: "4715 Golden Gate Pkwy, Naples, FL 34116", lat: 26.17418, lon: -81.76703 },
    { name: "DL — Naples (Orange Blossom)", addr: "2335 Orange Blossom Dr, Naples, FL 34109", lat: 26.14220, lon: -81.79429 },
    { name: "DL — Naples (Tamiami Tr)", addr: "3291 Tamiami Tr E, Naples, FL 34112", lat: 26.14220, lon: -81.79429 },
    ...
    { name: "DL — New Port Richey (Citizens Dr)", addr: "8731 Citizens Dr, New Port Richey, FL 34654", lat: 28.24418, lon: -82.71927 },
    { name: "DL — New Port Richey (US Hwy)", addr: "4720 US Hwy 19, New Port Richey, FL 34652", lat: 28.26851, lon: -82.72636 },
    { name: "DL — New Smyrna Beach", addr: "124 N Riverside Dr, New Smyrna Beach, FL 32168", lat: 29.02621, lon: -80.92152 },
    ...
    { name: "DL — North Miami Beach (NE 167)", addr: "313 NE 167 St, North Miami Beach, FL 33162", lat: 25.93315, lon: -80.16255 },
    { name: "DL — North Port", addr: "4970 City Hall Blvd, North Port, FL 34286", lat: 27.07573, lon: -82.20641 },
    { name: "DL — Ocala (N US)", addr: "7135 N US Hwy 441, Ocala, FL 34475", lat: 29.18720, lon: -82.14009 },
    ...
    { name: "DL — Ocala (SW State)", addr: "6154 SW State Rd 200, Ocala, FL 34476", lat: 29.18720, lon: -82.14009 },
    { name: "DL — Ocoee", addr: "9401 W Colonial Dr, Ocoee, FL 34761", lat: 28.55173, lon: -81.53925 },
    { name: "DL — Okeechobee (E State)", addr: "30076 E State Rd 78, Okeechobee, FL 34974", lat: 27.24371, lon: -80.82990 },
    ...
    { name: "DL — Oviedo", addr: "1490 Swanson Dr, Oviedo, FL 32765", lat: 28.67025, lon: -81.20849 },
    { name: "DL — Pace", addr: "4487 Chumuckla Hwy, Pace, FL 32571", lat: 30.60113, lon: -87.16162 },
    { name: "DL — Palatka", addr: "312 Oak St, Palatka, FL 32177", lat: 29.64587, lon: -81.63158 },
    { name: "DL — Palm Bay", addr: "450 Cogan Dr, Palm Bay, FL 32908", lat: 27.94375, lon: -80.65879 },
    { name: "DL — Palm Beach Gardens", addr: "3185 PGA Blvd, Palm Beach Gardens, FL 33410", lat: 26.84495, lon: -80.08681 },
    { name: "DL — Palm City", addr: "3001 SW Martin Downs Blvd, Palm City, FL 34990", lat: 27.17413, lon: -80.29454 },
    { name: "DL — Palm Coast", addr: "213 St Joe Plaza Dr, Palm Coast, FL 32164", lat: 29.55414, lon: -81.22077 },
    { name: "DL — Panama City", addr: "850 W 11th St, Panama City, FL 32401", lat: 30.16988, lon: -85.67300 },
    { name: "DL — Panama City Beach", addr: "10520 Hutchinson Blvd, Panama City Beach, FL 32407", lat: 30.17659, lon: -85.80539 },
    ...
    { name: "DL — Pensacola (N Navy)", addr: "507 N Navy Blvd, Pensacola, FL 32507", lat: 30.41229, lon: -87.24994 },
    ...
    { name: "DL — Pompano Beach", addr: "1955 Federal Hwy, Pompano Beach, FL 33062", lat: 26.25696, lon: -80.10295 },
    { name: "DL — Ponte Vedra Beach", addr: "151 Sawgrass Corners Dr, Ponte Vedra Beach, FL 32082", lat: 30.23969, lon: -81.38564 },
    { name: "DL — Port Charlotte (-B Olean)", addr: "21229-B Olean Blvd, Port Charlotte, FL 33952", lat: 26.97617, lon: -82.09064 },
    ...
    { name: "DL — Port St Lucie (SW Village)", addr: "10264 SW Village Pkwy Dr, Port St Lucie, FL 34987", lat: 27.29393, lon: -80.35033 },
    { name: "DL — Punta Gorda", addr: "410 Taylor St, Punta Gorda, FL 33950", lat: 26.93312, lon: -82.04893 },
    ...
    { name: "DL — Sebastian", addr: "1921 US Hwy 1, Sebastian, FL 32958", lat: 27.81736, lon: -80.46940 },
    { name: "DL — Sebring", addr: "540 S Commerce Ave, Sebring, FL 33870", lat: 27.49170, lon: -81.43615 },
    { name: "DL — Shalimar", addr: "1250 N Eglin Pkwy, Shalimar, FL 32579", lat: 30.44575, lon: -86.57912 },
    { name: "DL — Silver Springs", addr: "15956 E State Rd 40, Silver Springs, FL 34488", lat: 29.21662, lon: -82.05758 },
    { name: "DL — Sneads", addr: "8087 US Hwy 90, Sneads, FL 32460", lat: 30.70759, lon: -84.92445 },
    { name: "DL — South Daytona", addr: "2400 S Ridgewood Ave, South Daytona, FL 32119", lat: 29.16425, lon: -81.00068 },
    { name: "DL — Spring Hill", addr: "7489 Forest Oaks Blvd, Spring Hill, FL 34606", lat: 28.49107, lon: -82.59216 },
    { name: "DL — St Augustine (Lewis Speedway)", addr: "4030 Lewis Speedway, St Augustine, FL 32084", lat: 29.93996, lon: -81.33637 },
    ...
    { name: "DL — Tallahassee (N Monroe)", addr: "3840 N Monroe St, Tallahassee, FL 32303", lat: 30.46486, lon: -84.28311 },
    ...
    { name: "DL — Tampa (W Dr)", addr: "4100 W Dr MLK Jr Blvd, Tampa, FL 33614", lat: 27.94499, lon: -82.45831 },
    ...
    { name: "DL — The Villages", addr: "8033 E County Rd 466, The Villages, FL 32162", lat: 28.92700, lon: -82.00418 },
    ...
    { name: "DL — Venice", addr: "4000 S Tamiami Tr, Venice, FL 34293", lat: 27.09983, lon: -82.44428 },
    { name: "DL — Vero Beach (27th St)", addr: "1800 27th St, Vero Beach, FL 32960", lat: 27.64706, lon: -80.40295 },
    { name: "DL — Vero Beach (82nd Ave)", addr: "1860 82nd Ave, Vero Beach, FL 32966", lat: 27.63872, lon: -80.39754 },
    { name: "DL — Vero Beach (Cardinal Dr)", addr: "3003 Cardinal Dr, Vero Beach, FL 32963", lat: 27.64977, lon: -80.35675 },
    { name: "DL — Viera", addr: "2725 Judge Fran Jamieson Blvd, Viera, FL 32940", lat: 28.24301, lon: -80.73015 },
    ...
    { name: "DL — Williston", addr: "506 SW 1st Ave, Williston, FL 32696", lat: 29.38586, lon: -82.44860 },
    { name: "DL — Winter Haven", addr: "300 Ave M NW, Winter Haven, FL 33880", lat: 28.03448, lon: -81.72903 },
    { name: "DL — Winter Springs", addr: "1495 E State Rd 434, Winter Springs, FL 32708", lat: 28.69873, lon: -81.30552 },
  ],
};
