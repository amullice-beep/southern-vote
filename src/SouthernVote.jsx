...
import { STATES, STATE_ORDER, ELECTION_DAY } from "./data/states.js";
...
/* ----------------------------- STATE DATA -------------------------------- */
// STATES, STATE_ORDER, and ELECTION_DAY now live in src/data/states.js — the
// single source of truth shared with the automated reminder sender
// (scripts/send-reminders.js), so the emails always match what the app shows.
// Edit deadlines there, then `npm run build` and redeploy.
...
/* Driver-license / DMV office coordinates per state for the distance feature.
   Complete official office lists for all nine states (GA DDS, TX DPS, NC DMV,
   TN Driver Services, LA OMV, AL ALEA, SC DMV, MS DPS, FL tax-collector DL
   offices), geocoded via Nominatim and bounds-checked. A minority of coords
   are city-level approximations where a street address didn't geocode cleanly;
   the official locator link always governs for exact addresses and live hours. */
const DMV_OFFICES = {
  GA: [
  ...
  FL: [
    { name: "DL — Altamonte Springs", addr: "150 N Westmonte Dr, Altamonte Springs, FL 32714", lat: 28.66637, lon: -81.39339 },
    { name: "DL — Apalachicola", addr: "33 Market St, Apalachicola, FL 32320", lat: 29.72731, lon: -84.98425 },
    { name: "DL — Arcadia", addr: "201 E Oak St, Arcadia, FL 34266", lat: 27.21461, lon: -81.85778 },
    { name: "DL — Avon Park", addr: "116 E Main St, Avon Park, FL 33825", lat: 27.59595, lon: -81.50177 },
    { name: "DL — Bartow", addr: "430 E Main St, Bartow, FL 33830", lat: 27.89685, lon: -81.83004 },
    { name: "DL — Bell", addr: "1130 S Main St, Bell, FL 32619", lat: 29.75859, lon: -82.85906 },
    { name: "DL — Belle Glade", addr: "2976 State Rd 15, Belle Glade, FL 33430", lat: 26.68655, lon: -80.67030 },
    { name: "DL — Belleview", addr: "10445 SE US Hwy 441, Belleview, FL 34420", lat: 29.05165, lon: -82.04161 },
    { name: "DL — Big Pine Key", addr: "201 Key Deer Blvd, Big Pine Key, FL 33043", lat: 24.67273, lon: -81.35805 },
    { name: "DL — Blountstown", addr: "20859 Central Ave E, Blountstown, FL 32424", lat: 30.44320, lon: -85.04369 },
    { name: "DL — Bonifay", addr: "224 N Waukesha St, Bonifay, FL 32425", lat: 30.79332, lon: -85.67948 },
    { name: "DL — Bonita Springs", addr: "25987 S Tamiami Trail, Bonita Springs, FL 34135", lat: 26.36353, lon: -81.80758 },
    { name: "DL — Bradenton (111th St)", addr: "6007 111th St E, Bradenton, FL 34211", lat: 27.44940, lon: -82.40618 },
    { name: "DL — Bradenton (14th St)", addr: "5756 14th St W, Bradenton, FL 34207", lat: 27.43911, lon: -82.57553 },
    { name: "DL — Bradenton (301 Blvd)", addr: "819 301 Blvd W, Bradenton, FL 34205", lat: 27.46961, lon: -82.56900 },
    { name: "DL — Brandon", addr: "3030 N Falkenburg Rd, Brandon, FL 33511", lat: 27.91511, lon: -82.29817 },
    { name: "DL — Branford", addr: "604 Suwannee Ave, Branford, FL 32008", lat: 29.96257, lon: -82.93090 },
    { name: "DL — Bristol", addr: "10818 NW SR 20, Bristol, FL 32321", lat: 30.38785, lon: -84.98212 },
    { name: "DL — Bronson", addr: "310 School St, Bronson, FL 32621", lat: 29.44830, lon: -82.63338 },
    { name: "DL — Brooksville", addr: "20 N Main St, Brooksville, FL 34601", lat: 28.55510, lon: -82.38776 },
    { name: "DL — Bunnell", addr: "1769 E Moody Blvd, Bunnell, FL 32110", lat: 29.46871, lon: -81.24535 },
    { name: "DL — Bushnell", addr: "220 E McCollum Ave, Bushnell, FL 33513", lat: 28.66447, lon: -82.10892 },
    { name: "DL — Callahan", addr: "450077 State Rd 200, Callahan, FL 32011", lat: 30.55877, lon: -81.82050 },
    { name: "DL — Callaway", addr: "805 S Tyndall Pkwy, Callaway, FL 32404", lat: 30.13266, lon: -85.59051 },
    { name: "DL — Cape Coral", addr: "1039 SE 9th Ave, Cape Coral, FL 33990", lat: 26.63334, lon: -81.95553 },
    { name: "DL — Carrabelle", addr: "912 NW Ave A, Carrabelle, FL 32322", lat: 29.85295, lon: -84.66625 },
    { name: "DL — Casselberry", addr: "104 Wilshire Blvd, Casselberry, FL 32707", lat: 28.65117, lon: -81.32844 },
    { name: "DL — Chiefland", addr: "226 N Main St, Chiefland, FL 32626", lat: 29.48109, lon: -82.86014 },
    { name: "DL — Chipley", addr: "1331 S Blvd, Chipley, FL 32428", lat: 30.77125, lon: -85.54325 },
    { name: "DL — Clearwater (Gulf to)", addr: "1663 Gulf to Bay Blvd, Clearwater, FL 33755", lat: 27.96058, lon: -82.76823 },
    { name: "DL — Clearwater (Hwy 19)", addr: "29399 Hwy 19 N, Clearwater, FL 34621", lat: 28.01172, lon: -82.73387 },
    { name: "DL — Clermont", addr: "1505 Hooks St, Clermont, FL 34711", lat: 28.54221, lon: -81.72902 },
    { name: "DL — Clewiston", addr: "1100 S Olympia, Clewiston, FL 33440", lat: 26.74323, lon: -80.94012 },
    { name: "DL — Coral Gables", addr: "1418 Ponce de Leon Blvd, Coral Gables, FL 33134", lat: 25.75853, lon: -80.25921 },
    { name: "DL — Coral Springs", addr: "1160 N University Dr, Coral Springs, FL 33071", lat: 26.24523, lon: -80.25343 },
    { name: "DL — Crawfordville", addr: "202 Ochlocknee St, Crawfordville, FL 32327", lat: 30.19392, lon: -84.33416 },
    { name: "DL — Crescent City", addr: "115 N Summit St, Crescent City, FL 32112", lat: 29.43169, lon: -81.51054 },
    { name: "DL — Crestview", addr: "302 N Wilson Blvd, Crestview, FL 32536", lat: 30.75416, lon: -86.58600 },
    { name: "DL — Cross City", addr: "214 NE 351 Hwy, Cross City, FL 32628", lat: 29.72825, lon: -83.00153 },
    { name: "DL — Crystal River", addr: "1540 N Meadowcrest Blvd, Crystal River, FL 34429", lat: 28.87393, lon: -82.58745 },
    { name: "DL — Dade City", addr: "14236 6th Street, Dade City, FL 33523", lat: 28.36547, lon: -82.18814 },
    { name: "DL — Davenport", addr: "2000 Deer Creek Commerce Ln, Davenport, FL 33837", lat: 28.21984, lon: -81.59299 },
    { name: "DL — Daytona Beach", addr: "1845 Holsonback Dr, Daytona Beach, FL 32117", lat: 29.21286, lon: -81.07869 },
    { name: "DL — DeFuniak Springs", addr: "571 US Hwy 90 E, DeFuniak Springs, FL 32433", lat: 30.78231, lon: -86.18398 },
    { name: "DL — DeLand", addr: "123 W Indiana Ave, DeLand, FL 32720", lat: 29.02945, lon: -81.30502 },
    { name: "DL — Deerfield Beach", addr: "2265-A W Hillsboro Blvd, Deerfield Beach, FL 33442", lat: 26.31779, lon: -80.15340 },
    { name: "DL — Delray Beach", addr: "501 S Congress Ave, Delray Beach, FL 33445", lat: 26.45236, lon: -80.09309 },
    { name: "DL — Deltona", addr: "1200 Deltona Blvd, Deltona, FL 32725", lat: 28.89786, lon: -81.27116 },
    { name: "DL — Destin", addr: "4012 Commons Dr W, Destin, FL 32541", lat: 30.39083, lon: -86.45451 },
    { name: "DL — Dunnellon", addr: "19995 SW 86th St, Dunnellon, FL 34431", lat: 29.11815, lon: -82.48885 },
    { name: "DL — Eglin AFB", addr: "310 W Van Matre, Eglin AFB, FL 32542", lat: 30.47363, lon: -86.54964 },
    { name: "DL — Ellenton", addr: "4333 US Hwy 301 N, Ellenton, FL 34222", lat: 27.53546, lon: -82.50291 },
    { name: "DL — Englewood", addr: "6868 San Casa Dr, Englewood, FL 34224", lat: 26.93067, lon: -82.31306 },
    { name: "DL — Everglades City", addr: "102 Copeland Ave N, Everglades City, FL 34139", lat: 25.85520, lon: -81.38040 },
    { name: "DL — Fernandina Beach (Centre St)", addr: "416 Centre St, Fernandina Beach, FL 32034", lat: 30.67100, lon: -81.46188 },
    { name: "DL — Fernandina Beach (License Rd)", addr: "86130 License Rd, Fernandina Beach, FL 32034", lat: 30.62189, lon: -81.46229 },
    { name: "DL — Flagler Beach", addr: "2525 Moody Blvd, Flagler Beach, FL 32136", lat: 29.47639, lon: -81.14881 },
    { name: "DL — Florida City", addr: "1448 N Krome Ave, Florida City, FL 33034", lat: 25.46106, lon: -80.47817 },
    { name: "DL — Fort Lauderdale", addr: "1113 N Federal Hwy, Fort Lauderdale, FL 33304", lat: 26.13903, lon: -80.11989 },
    { name: "DL — Fort Myers (Pine Ridge)", addr: "15680 Pine Ridge Rd, Fort Myers, FL 33908", lat: 26.50581, lon: -81.93134 },
    { name: "DL — Fort Myers (S Tamiami)", addr: "18990 S Tamiami Trail, Fort Myers, FL 33908", lat: 26.50581, lon: -81.93134 },
    { name: "DL — Fort Myers (Thompson St)", addr: "2480 Thompson St, Fort Myers, FL 33901", lat: 26.64135, lon: -81.86311 },
    { name: "DL — Fort Pierce", addr: "2300 Virginia Ave, Fort Pierce, FL 34982", lat: 27.42594, lon: -80.34768 },
    { name: "DL — Fort White", addr: "118 SW Wilson Springs Rd, Fort White, FL 32038", lat: 29.92141, lon: -82.71417 },
    { name: "DL — Freeport", addr: "842 State Hwy 20 E, Freeport, FL 32439", lat: 30.47908, lon: -86.15763 },
    { name: "DL — Gainesville (NW 34th)", addr: "5830 NW 34th Blvd, Gainesville, FL 32653", lat: 29.70883, lon: -82.35463 },
    { name: "DL — Gainesville (SE 1st)", addr: "12 SE 1st St, Gainesville, FL 32601", lat: 29.65146, lon: -82.32427 },
    { name: "DL — Gainesville (Windmeadows Blvd)", addr: "3837 Windmeadows Blvd, Gainesville, FL 32608", lat: 29.62410, lon: -82.38056 },
    { name: "DL — Graceville", addr: "5422 Cliff St, Graceville, FL 32440", lat: 30.96355, lon: -85.51347 },
    { name: "DL — Green Cove Springs", addr: "477 Houston St, Green Cove Springs, FL 32043", lat: 30.00063, lon: -81.68445 },
    { name: "DL — Greenacres", addr: "4215 S Military Trail, Greenacres, FL 33463", lat: 26.62190, lon: -80.11346 },
    { name: "DL — Gulf Breeze", addr: "5841 Gulf Breeze Pkwy, Gulf Breeze, FL 32563", lat: 30.36829, lon: -87.17371 },
    { name: "DL — Hialeah (NW 138th)", addr: "11093 NW 138th St, Hialeah, FL 33018", lat: 25.89803, lon: -80.37821 },
    { name: "DL — Hialeah (NW 186th)", addr: "6402 NW 186th St, Hialeah, FL 33015", lat: 25.94240, lon: -80.31924 },
    { name: "DL — Hialeah (W 49th)", addr: "20 W 49th St, Hialeah, FL 33012", lat: 25.86657, lon: -80.28392 },
    { name: "DL — Hialeah (W 84th)", addr: "1550 W 84th St, Hialeah, FL 33014", lat: 25.89761, lon: -80.31453 },
    { name: "DL — Hialeah Gardens", addr: "11920 NW 87 Ct, Hialeah Gardens, FL 33018", lat: 25.90120, lon: -80.34974 },
    { name: "DL — High Springs", addr: "23718 W US Hwy 27, High Springs, FL 32643", lat: 29.87719, lon: -82.60923 },
    { name: "DL — Hilliard", addr: "15885 County Rd 108, Hilliard, FL 32046", lat: 30.70411, lon: -81.92157 },
    { name: "DL — Hobe Sound", addr: "11734 SE Federal Hwy, Hobe Sound, FL 33455", lat: 27.06242, lon: -80.13774 },
    { name: "DL — Hollywood", addr: "3387 Sheridan St, Hollywood, FL 33021", lat: 26.03313, lon: -80.17754 },
    { name: "DL — Homestead", addr: "30708 S Federal Hwy, Homestead, FL 33030", lat: 25.47853, lon: -80.48749 },
    { name: "DL — Immokalee", addr: "106 S 1st St, Immokalee, FL 34142", lat: 26.42534, lon: -81.41755 },
    { name: "DL — Indiantown", addr: "16550 SW Warfield Blvd, Indiantown, FL 34956", lat: 27.02847, lon: -80.47949 },
    { name: "DL — Interlachen", addr: "1114 State Rd 20 W, Interlachen, FL 32148", lat: 29.63380, lon: -81.87834 },
    { name: "DL — Inverness", addr: "210 N Apopka Ave, Inverness, FL 34450", lat: 28.83904, lon: -82.33011 },
    { name: "DL — Jacksonville (Atlantic Blvd)", addr: "12220 Atlantic Blvd, Jacksonville, FL 32225", lat: 30.32356, lon: -81.50425 },
    { name: "DL — Jacksonville (E Forsyth)", addr: "231 E Forsyth St, Jacksonville, FL 32202", lat: 30.32673, lon: -81.65417 },
    { name: "DL — Jacksonville (Hogan Rd)", addr: "7120-15 Hogan Rd, Jacksonville, FL 32216", lat: 30.28464, lon: -81.58126 },
    { name: "DL — Jacksonville (N Main)", addr: "12961 N Main St, Jacksonville, FL 32218", lat: 30.36055, lon: -81.65355 },
    { name: "DL — Jacksonville (Roosevelt Blvd)", addr: "6331 Roosevelt Blvd, Jacksonville, FL 32244", lat: 30.23392, lon: -81.69816 },
    { name: "DL — Jacksonville (San Jose)", addr: "10035 San Jose Blvd, Jacksonville, FL 32257", lat: 30.19485, lon: -81.62209 },
    { name: "DL — Jacksonville (Soutel Dr)", addr: "4750 Soutel Dr, Jacksonville, FL 32208", lat: 30.40344, lon: -81.72082 },
    { name: "DL — Jacksonville (W Beaver)", addr: "8299-10 W Beaver St, Jacksonville, FL 32220", lat: 30.32295, lon: -81.76605 },
    { name: "DL — Jasper", addr: "207 NE 1st St, Jasper, FL 32052", lat: 30.51939, lon: -82.94598 },
    { name: "DL — Jay", addr: "5259 Booker Ln, Jay, FL 32565", lat: 30.95186, lon: -87.16039 },
    { name: "DL — Key Largo", addr: "101487 Overseas Hwy, Key Largo, FL 33037", lat: 25.11469, lon: -80.42142 },
    { name: "DL — Key West (N Roosevelt)", addr: "3304 N Roosevelt Blvd, Key West, FL 33040", lat: 24.55828, lon: -81.78782 },
    { name: "DL — Key West (Truman Ave)", addr: "1200 Truman Ave, Key West, FL 33040", lat: 24.55616, lon: -81.79104 },
    { name: "DL — Keystone Heights (SE 8th)", addr: "3979 SE 8th Ave, Keystone Heights, FL 32656", lat: 29.79471, lon: -81.99368 },
    { name: "DL — Keystone Heights (State Rd)", addr: "7380 State Rd 100, Keystone Heights, FL 32656", lat: 29.79471, lon: -81.99368 },
    { name: "DL — Kissimmee (E Irlo)", addr: "2501 E Irlo Bronson Memorial Hwy, Kissimmee, FL 34744", lat: 28.30247, lon: -81.36330 },
    { name: "DL — Kissimmee (S Orange)", addr: "4730 S Orange Blossom Trail, Kissimmee, FL 34746", lat: 28.30424, lon: -81.47118 },
    { name: "DL — Kissimmee (Simpson Rd)", addr: "2595 Simpson Rd, Kissimmee, FL 34744", lat: 28.32144, lon: -81.33803 },
    { name: "DL — Labelle", addr: "25 E Hickpoochee Ave, Labelle, FL 33935", lat: 26.76588, lon: -81.44987 },
    { name: "DL — Lake Alfred", addr: "200 Government Center Blvd, Lake Alfred, FL 33850", lat: 28.09153, lon: -81.72698 },
    { name: "DL — Lake Butler", addr: "55 W Main St, Lake Butler, FL 32054", lat: 30.02321, lon: -82.33858 },
    { name: "DL — Lake City", addr: "135 NE Hernando Ave, Lake City, FL 32055", lat: 30.18979, lon: -82.63607 },
    { name: "DL — Lake Mary", addr: "845 Primera Blvd, Lake Mary, FL 32746", lat: 28.76473, lon: -81.35372 },
    { name: "DL — Lake Placid", addr: "11 N Pine Ave, Lake Placid, FL 33852", lat: 27.29416, lon: -81.36530 },
    { name: "DL — Lake Wales", addr: "658 Hwy 60 W, Lake Wales, FL 33853", lat: 27.90080, lon: -81.55749 },
    { name: "DL — Lakeland (Florida Ave)", addr: "4130 Florida Ave S, Lakeland, FL 33813", lat: 27.98759, lon: -81.95664 },
    { name: "DL — Lakeland (N Massachusetts)", addr: "916 N Massachusetts Ave, Lakeland, FL 33801", lat: 28.05333, lon: -81.95432 },
    { name: "DL — Land O Lakes", addr: "4135 Land O Lakes Blvd, Land O Lakes, FL 34639", lat: 28.21707, lon: -82.45944 },
    { name: "DL — Largo", addr: "13025 Starkey Rd, Largo, FL 33773", lat: 27.88773, lon: -82.76227 },
    { name: "DL — Lauderdale Lakes", addr: "3718-3 W Oakland Park Blvd, Lauderdale Lakes, FL 33311", lat: 26.16465, lon: -80.21827 },
    { name: "DL — Lauderhill", addr: "1299-A NW 40th Ave, Lauderhill, FL 33313", lat: 26.14945, lon: -80.22521 },
    { name: "DL — Leesburg", addr: "1702 N Citrus Blvd, Leesburg, FL 34748", lat: 28.82946, lon: -81.88747 },
    { name: "DL — Lehigh Acres", addr: "600 Homestead Rd S, Lehigh Acres, FL 33974", lat: 26.56231, lon: -81.62488 },
    { name: "DL — Live Oak", addr: "215 Pine Ave SW, Live Oak, FL 32064", lat: 30.28330, lon: -82.98937 },
    { name: "DL — Loxahatchee", addr: "16440 Town Center Pkwy S, Loxahatchee, FL 33470", lat: 26.74743, lon: -80.30092 },
    { name: "DL — Lutz", addr: "4610 Pet Ln, Lutz, FL 33559", lat: 28.22302, lon: -82.37889 },
    { name: "DL — Lynn Haven", addr: "700 Florida Ave, Lynn Haven, FL 32444", lat: 30.24773, lon: -85.64982 },
    { name: "DL — Macclenny", addr: "32 N 5th St, Macclenny, FL 32063", lat: 30.28296, lon: -82.12263 },
    { name: "DL — Madison", addr: "229 SW Pinckney St, Madison, FL 32340", lat: 30.46852, lon: -83.41282 },
    { name: "DL — Marathon", addr: "3015 Overseas Hwy, Marathon, FL 33050", lat: 24.71054, lon: -81.09670 },
    { name: "DL — Marco Island", addr: "1040 Winterberry Dr, Marco Island, FL 34145", lat: 25.92182, lon: -81.72232 },
    { name: "DL — Margate", addr: "1135 Banks Rd, Margate, FL 33063", lat: 26.24210, lon: -80.19619 },
    { name: "DL — Marianna", addr: "4445 E Lafayette St, Marianna, FL 32446", lat: 30.77401, lon: -85.22453 },
    { name: "DL — Mayo", addr: "120 W Main St, Mayo, FL 32066", lat: 30.05537, lon: -83.18269 },
    { name: "DL — Melbourne", addr: "1515 Sarno Rd, Melbourne, FL 32935", lat: 28.12155, lon: -80.64503 },
    { name: "DL — Merritt Island", addr: "1605 N Courtenay Pkwy, Merritt Island, FL 32953", lat: 28.38529, lon: -80.70289 },
    { name: "DL — Miami (Bird Rd)", addr: "8530 Bird Rd, Miami, FL 33155", lat: 25.73304, lon: -80.33431 },
    { name: "DL — Miami (Hammocks Blvd)", addr: "10201 Hammocks Blvd, Miami, FL 33196", lat: 25.67251, lon: -80.44355 },
    { name: "DL — Miami (NE Miami)", addr: "1834 NE Miami Gardens Dr, Miami, FL 33179", lat: 25.94255, lon: -80.18156 },
    { name: "DL — Miami (NW 183rd)", addr: "804 NW 183rd St, Miami, FL 33169", lat: 25.94205, lon: -80.21491 },
    { name: "DL — Miami (NW 27)", addr: "7900 NW 27 Ave, Miami, FL 33147", lat: 25.85090, lon: -80.23644 },
    { name: "DL — Miami (NW 27th)", addr: "11035 NW 27th Ave, Miami, FL 33167", lat: 25.87498, lon: -80.24242 },
    { name: "DL — Miami (NW 2nd)", addr: "200 NW 2nd Ave, Miami, FL 33128", lat: 25.77664, lon: -80.19804 },
    { name: "DL — Miami (NW 36th)", addr: "1375 NW 36th St, Miami, FL 33142", lat: 25.80990, lon: -80.21922 },
    { name: "DL — Miami (NW 36th) #2", addr: "3636 NW 36th St, Miami, FL 33142", lat: 25.80849, lon: -80.25520 },
    { name: "DL — Miami (NW 54th)", addr: "2621 NW 54th St, Miami, FL 33142", lat: 25.82438, lon: -80.24009 },
    { name: "DL — Miami (NW 7th)", addr: "5747 NW 7th St, Miami, FL 33126", lat: 25.77954, lon: -80.29039 },
    { name: "DL — Miami (NW 7th) #2", addr: "3721 NW 7th St, Miami, FL 33126", lat: 25.78146, lon: -80.25814 },
    { name: "DL — Miami (NW 7th) #3", addr: "18326 NW 7th Ave, Miami, FL 33169", lat: 25.94320, lon: -80.21536 },
    { name: "DL — Miami (S Dixie)", addr: "11287 S Dixie Hwy, Miami, FL 33156", lat: 25.66561, lon: -80.32336 },
    { name: "DL — Miami (S Dixie) #2", addr: "18655 S Dixie Hwy, Miami, FL 33157", lat: 25.59464, lon: -80.35524 },
    { name: "DL — Miami (SW 11th)", addr: "7356 SW 11th Ave, Miami, FL 33183", lat: 25.76340, lon: -80.21266 },
    { name: "DL — Miami (SW 122)", addr: "14653 SW 122 Ave, Miami, FL 33186", lat: 25.65925, lon: -80.40778 },
    { name: "DL — Miami (SW 147th)", addr: "11735 SW 147th Ave, Miami, FL 33196", lat: 25.65819, lon: -80.43059 },
    { name: "DL — Miami (SW 56th)", addr: "13710-K SW 56th St, Miami, FL 33175", lat: 25.73351, lon: -80.41106 },
    { name: "DL — Miami (SW 8th)", addr: "2517 SW 8th St, Miami, FL 33135", lat: 25.76531, lon: -80.23700 },
    { name: "DL — Miami (W Flagler)", addr: "7795 W Flagler St, Miami, FL 33126", lat: 25.77450, lon: -80.32166 },
    { name: "DL — Miami (W Flagler) #2", addr: "10930 W Flagler St, Miami, FL 33174", lat: 25.76828, lon: -80.37379 },
    { name: "DL — Miami Beach", addr: "800 71st St, Miami Beach, FL 33141", lat: 25.85579, lon: -80.12620 },
    { name: "DL — Middleburg", addr: "2710 Blanding Blvd, Middleburg, FL 32068", lat: 30.06161, lon: -81.87556 },
    { name: "DL — Milton", addr: "6495 Caroline St, Milton, FL 32570", lat: 30.61636, lon: -87.05192 },
    { name: "DL — Molino", addr: "6440 Hwy 95-A N, Molino, FL 32577", lat: 30.70493, lon: -87.36061 },
    { name: "DL — Monticello", addr: "500 W Walnut St, Monticello, FL 32344", lat: 30.54438, lon: -83.87101 },
    { name: "DL — Moore Haven", addr: "500 Ave J, Moore Haven, FL 33471", lat: 26.83272, lon: -81.09971 },
    { name: "DL — Naples (8th St)", addr: "735 8th St S, Naples, FL 34102", lat: 26.13914, lon: -81.79527 },
    { name: "DL — Naples (Airport Rd)", addr: "725 Airport Rd S, Naples, FL 34104", lat: 26.15322, lon: -81.74193 },
    { name: "DL — Naples (Collier Blvd)", addr: "6654 Collier Blvd, Naples, FL 34114", lat: 26.04267, lon: -81.66023 },
    { name: "DL — Naples (Collier Blvd) #2", addr: "15450 Collier Blvd, Naples, FL 34120", lat: 26.28020, lon: -81.60241 },
    { name: "DL — Naples (Golden Gate)", addr: "4715 Golden Gate Pkwy, Naples, FL 34116", lat: 26.17418, lon: -81.76703 },
    { name: "DL — Naples (Orange Blossom)", addr: "2335 Orange Blossom Dr, Naples, FL 34109", lat: 26.23955, lon: -81.77105 },
    { name: "DL — Naples (Tamiami Tr)", addr: "3291 Tamiami Tr E, Naples, FL 34112", lat: 26.12243, lon: -81.74966 },
    { name: "DL — Naples (Wilson Blvd)", addr: "50 Wilson Blvd S, Naples, FL 34117", lat: 26.22894, lon: -81.60728 },
    { name: "DL — Neptune Beach", addr: "1505 Atlantic Blvd, Neptune Beach, FL 32266", lat: 30.32356, lon: -81.41455 },
    { name: "DL — New Port Richey (Citizens Dr)", addr: "8731 Citizens Dr, New Port Richey, FL 34654", lat: 28.30649, lon: -82.63193 },
    { name: "DL — New Port Richey (US Hwy)", addr: "4720 US Hwy 19, New Port Richey, FL 34652", lat: 28.26934, lon: -82.72572 },
    { name: "DL — New Smyrna Beach", addr: "124 N Riverside Dr, New Smyrna Beach, FL 32168", lat: 29.02597, lon: -80.92113 },
    { name: "DL — Niceville", addr: "701 E John Sims Pkwy, Niceville, FL 32578", lat: 30.50949, lon: -86.44277 },
    { name: "DL — North Fort Myers", addr: "15201 N Cleveland Ave, North Fort Myers, FL 33903", lat: 26.68581, lon: -81.90437 },
    { name: "DL — North Miami", addr: "12935 W Dixie Hwy, North Miami, FL 33161", lat: 25.89439, lon: -80.18302 },
    { name: "DL — North Miami Beach (Biscayne Blvd)", addr: "15555 Biscayne Blvd, North Miami Beach, FL 33160", lat: 25.91818, lon: -80.15554 },
    { name: "DL — North Miami Beach (NE 167)", addr: "313 NE 167 St, North Miami Beach, FL 33162", lat: 25.92878, lon: -80.17853 },
    { name: "DL — North Port", addr: "4970 City Hall Blvd, North Port, FL 34286", lat: 27.07573, lon: -82.20641 },
    { name: "DL — Ocala (N US)", addr: "7135 N US Hwy 441, Ocala, FL 34475", lat: 29.21433, lon: -82.15509 },
    { name: "DL — Ocala (SE 25th)", addr: "110 SE 25th Ave, Ocala, FL 34471", lat: 29.18676, lon: -82.10325 },
    { name: "DL — Ocala (SE 25th) #2", addr: "503 SE 25th Ave, Ocala, FL 34471", lat: 29.18264, lon: -82.10319 },
    { name: "DL — Ocala (SW State)", addr: "6154 SW State Rd 200, Ocala, FL 34476", lat: 29.08339, lon: -82.21315 },
    { name: "DL — Ocoee", addr: "9401 W Colonial Dr, Ocoee, FL 34761", lat: 28.55156, lon: -81.53887 },
    { name: "DL — Okeechobee (E State)", addr: "30076 E State Rd 78, Okeechobee, FL 34974", lat: 27.19330, lon: -80.90545 },
    { name: "DL — Okeechobee (NW 2nd)", addr: "409 NW 2nd Ave, Okeechobee, FL 34972", lat: 27.24779, lon: -80.83119 },
    { name: "DL — Orange City", addr: "2575 S Volusia Ave, Orange City, FL 32763", lat: 28.91467, lon: -81.30247 },
    { name: "DL — Orange Park", addr: "1518 Park Ave, Orange Park, FL 32073", lat: 30.17150, lon: -81.70264 },
    { name: "DL — Orlando (Clarcona Ocoee)", addr: "4101 Clarcona Ocoee Rd, Orlando, FL 32810", lat: 28.61423, lon: -81.43028 },
    { name: "DL — Orlando (S Rosalind)", addr: "301 S Rosalind Ave, Orlando, FL 32801", lat: 28.53894, lon: -81.37575 },
    { name: "DL — Orlando (Sand Lake)", addr: "730 Sand Lake Rd, Orlando, FL 32809", lat: 28.45056, lon: -81.40889 },
    { name: "DL — Orlando (University Blvd)", addr: "10051 University Blvd, Orlando, FL 32817", lat: 28.59943, lon: -81.24411 },
    { name: "DL — Orlando (Wooden Pine)", addr: "6050 Wooden Pine Dr, Orlando, FL 32829", lat: 28.47831, lon: -81.23763 },
    { name: "DL — Oviedo", addr: "1490 Swanson Dr, Oviedo, FL 32765", lat: 28.65156, lon: -81.21498 },
    { name: "DL — Pace", addr: "4487 Chumuckla Hwy, Pace, FL 32571", lat: 30.60113, lon: -87.16162 },
    { name: "DL — Palatka", addr: "312 Oak St, Palatka, FL 32177", lat: 29.64587, lon: -81.63157 },
    { name: "DL — Palm Bay", addr: "450 Cogan Dr, Palm Bay, FL 32908", lat: 27.94375, lon: -80.65879 },
    { name: "DL — Palm Beach Gardens", addr: "3185 PGA Blvd, Palm Beach Gardens, FL 33410", lat: 26.84494, lon: -80.08632 },
    { name: "DL — Palm City", addr: "3001 SW Martin Downs Blvd, Palm City, FL 34990", lat: 27.17413, lon: -80.29454 },
    { name: "DL — Palm Coast", addr: "213 St Joe Plaza Dr, Palm Coast, FL 32164", lat: 29.49307, lon: -81.21945 },
    { name: "DL — Panama City", addr: "850 W 11th St, Panama City, FL 32401", lat: 30.16988, lon: -85.67300 },
    { name: "DL — Panama City Beach", addr: "10520 Hutchinson Blvd, Panama City Beach, FL 32407", lat: 30.19181, lon: -85.80764 },
    { name: "DL — Pembroke Pines (Pembroke Rd)", addr: "8001 Pembroke Rd, Pembroke Pines, FL 33025", lat: 25.99507, lon: -80.24812 },
    { name: "DL — Pembroke Pines (S Flamingo)", addr: "294 S Flamingo Rd, Pembroke Pines, FL 33026", lat: 26.00534, lon: -80.31203 },
    { name: "DL — Pensacola (Barrancas Ave)", addr: "4051 Barrancas Ave, Pensacola, FL 32507", lat: 30.40201, lon: -87.24770 },
    { name: "DL — Pensacola (N Navy)", addr: "507 N Navy Blvd, Pensacola, FL 32507", lat: 30.41220, lon: -87.24787 },
    { name: "DL — Pensacola (N W)", addr: "6451 N W St, Pensacola, FL 32505", lat: 30.41530, lon: -87.25070 },
    { name: "DL — Perry (N Jefferson)", addr: "108 N Jefferson St, Perry, FL 32347", lat: 30.10456, lon: -83.58246 },
    { name: "DL — Perry (US Hwy)", addr: "2275 US Hwy 19 N, Perry, FL 32347", lat: 30.10173, lon: -83.58694 },
    { name: "DL — Plant City", addr: "4706 Sydney Rd, Plant City, FL 33566", lat: 27.98611, lon: -82.17060 },
    { name: "DL — Plantation", addr: "1800 NW 66th Ave, Plantation, FL 33313", lat: 26.14801, lon: -80.23681 },
    { name: "DL — Pompano Beach", addr: "1955 Federal Hwy, Pompano Beach, FL 33062", lat: 26.25498, lon: -80.10013 },
    { name: "DL — Ponte Vedra Beach", addr: "151 Sawgrass Corners Dr, Ponte Vedra Beach, FL 32082", lat: 30.14767, lon: -81.37121 },
    { name: "DL — Port Charlotte (Murdock Cir)", addr: "18500 Murdock Cir, Port Charlotte, FL 33948", lat: 27.00866, lon: -82.14086 },
    { name: "DL — Port Charlotte (Olean Blvd)", addr: "21229-B Olean Blvd, Port Charlotte, FL 33952", lat: 26.98558, lon: -82.10046 },
    { name: "DL — Port St Joe", addr: "1000 Cecil G Costin Sr Blvd, Port St Joe, FL 32456", lat: 29.81474, lon: -85.28995 },
    { name: "DL — Port St Lucie (SE Walton)", addr: "1664 SE Walton Rd, Port St Lucie, FL 34952", lat: 27.29881, lon: -80.28397 },
    { name: "DL — Port St Lucie (SW Village)", addr: "10264 SW Village Pkwy Dr, Port St Lucie, FL 34987", lat: 27.27972, lon: -80.44671 },
    { name: "DL — Punta Gorda", addr: "410 Taylor St, Punta Gorda, FL 33950", lat: 26.93312, lon: -82.04894 },
    { name: "DL — Quincy", addr: "16 S Calhoun St, Quincy, FL 32351", lat: 30.58625, lon: -84.58035 },
    { name: "DL — Ruskin", addr: "406 30th St, Ruskin, FL 33570", lat: 27.71629, lon: -82.39163 },
    { name: "DL — Sanford", addr: "1101 E 1st St, Sanford, FL 32771", lat: 28.81066, lon: -81.25594 },
    { name: "DL — Santa Rosa Beach", addr: "31 Coastal Centre Blvd, Santa Rosa Beach, FL 32459", lat: 30.37464, lon: -86.18030 },
    { name: "DL — Sarasota (S Washington)", addr: "101 S Washington Blvd, Sarasota, FL 34236", lat: 27.33350, lon: -82.53099 },
    { name: "DL — Sarasota (Sawyer Loop)", addr: "6400 Sawyer Loop Rd, Sarasota, FL 34238", lat: 27.26021, lon: -82.47581 },
    { name: "DL — Sebastian", addr: "1921 US Hwy 1, Sebastian, FL 32958", lat: 27.77673, lon: -80.48136 },
    { name: "DL — Sebring", addr: "540 S Commerce Ave, Sebring, FL 33870", lat: 27.49170, lon: -81.43615 },
    { name: "DL — Shalimar", addr: "1250 N Eglin Pkwy, Shalimar, FL 32579", lat: 30.44426, lon: -86.57203 },
    { name: "DL — Silver Springs", addr: "15956 E State Rd 40, Silver Springs, FL 34488", lat: 29.20490, lon: -81.92454 },
    { name: "DL — Sneads", addr: "8087 US Hwy 90, Sneads, FL 32460", lat: 30.72164, lon: -84.93976 },
    { name: "DL — South Daytona", addr: "2400 S Ridgewood Ave, South Daytona, FL 32119", lat: 29.16402, lon: -81.00188 },
    { name: "DL — Spring Hill", addr: "7489 Forest Oaks Blvd, Spring Hill, FL 34606", lat: 28.49079, lon: -82.59352 },
    { name: "DL — St Augustine (Lewis Speedway)", addr: "4030 Lewis Speedway, St Augustine, FL 32084", lat: 29.93968, lon: -81.33853 },
    { name: "DL — St Augustine (US Hwy)", addr: "6658 US Hwy 1 S, St Augustine, FL 32086", lat: 29.87795, lon: -81.32656 },
    { name: "DL — St Cloud", addr: "1300 9th St, St Cloud, FL 34769", lat: 28.24982, lon: -81.28383 },
    { name: "DL — St Johns", addr: "725 Flora Branch Blvd, St Johns, FL 32259", lat: 30.11704, lon: -81.59082 },
    { name: "DL — St Petersburg", addr: "2500 34th St N, St Petersburg, FL 33713", lat: 27.79285, lon: -82.67958 },
    { name: "DL — Starke", addr: "945 N Temple Ave, Starke, FL 32091", lat: 29.95432, lon: -82.10872 },
    { name: "DL — Stuart", addr: "3485 SE Willoughby Blvd, Stuart, FL 34994", lat: 27.16782, lon: -80.24477 },
    { name: "DL — Summerfield", addr: "17860 SE 109th Ave, Summerfield, FL 34491", lat: 28.96157, lon: -81.96948 },
    { name: "DL — Sunrise", addr: "3511 N Pine Island Rd, Sunrise, FL 33351", lat: 26.17186, lon: -80.26781 },
    { name: "DL — Tallahassee (Metropolitan Blvd)", addr: "1276 Metropolitan Blvd, Tallahassee, FL 32312", lat: 30.50031, lon: -84.25576 },
    { name: "DL — Tallahassee (N Monroe)", addr: "3840 N Monroe St, Tallahassee, FL 32303", lat: 30.47139, lon: -84.29034 },
    { name: "DL — Tallahassee (S Monroe)", addr: "3477 S Monroe St, Tallahassee, FL 32301", lat: 30.40299, lon: -84.28052 },
    { name: "DL — Tampa (E Hillsborough)", addr: "2814 E Hillsborough Ave, Tampa, FL 33610", lat: 27.99735, lon: -82.42777 },
    { name: "DL — Tampa (E Kennedy)", addr: "601 E Kennedy Blvd, Tampa, FL 33602", lat: 27.94831, lon: -82.45482 },
    { name: "DL — Tampa (N Westshore)", addr: "1701 N Westshore Blvd, Tampa, FL 33607", lat: 27.95700, lon: -82.52360 },
    { name: "DL — Tampa (University Center)", addr: "3011 University Center Dr, Tampa, FL 33612", lat: 28.04497, lon: -82.42592 },
    { name: "DL — Tampa (W Dr)", addr: "4100 W Dr MLK Jr Blvd, Tampa, FL 33614", lat: 28.01138, lon: -82.50601 },
    { name: "DL — Tavares", addr: "1800 David Walker Dr, Tavares, FL 32778", lat: 28.81916, lon: -81.70431 },
    { name: "DL — Tavernier", addr: "88800 Overseas Hwy, Tavernier, FL 33070", lat: 25.00940, lon: -80.51692 },
    { name: "DL — The Villages", addr: "8033 E County Rd 466, The Villages, FL 32162", lat: 28.91629, lon: -81.98597 },
    { name: "DL — Titusville", addr: "800 S Park Ave, Titusville, FL 32780", lat: 28.60679, lon: -80.81866 },
    { name: "DL — Trenton", addr: "220 S Main St, Trenton, FL 32693", lat: 29.62092, lon: -82.81847 },
    { name: "DL — Venice", addr: "4000 S Tamiami Tr, Venice, FL 34293", lat: 27.05461, lon: -82.39412 },
    { name: "DL — Vero Beach (27th St)", addr: "1800 27th St, Vero Beach, FL 32960", lat: 27.64706, lon: -80.40295 },
    { name: "DL — Vero Beach (82nd Ave)", addr: "1860 82nd Ave, Vero Beach, FL 32966", lat: 27.64013, lon: -80.47314 },
    { name: "DL — Vero Beach (Cardinal Dr)", addr: "3003 Cardinal Dr, Vero Beach, FL 32963", lat: 27.64977, lon: -80.35676 },
    { name: "DL — Viera", addr: "2725 Judge Fran Jamieson Blvd, Viera, FL 32940", lat: 28.21502, lon: -80.72081 },
    { name: "DL — Wauchula", addr: "110 W Oak St, Wauchula, FL 33873", lat: 27.55004, lon: -81.81315 },
    { name: "DL — West Palm Beach", addr: "301 N Olive Ave, West Palm Beach, FL 33401", lat: 26.71536, lon: -80.05193 },
    { name: "DL — Weston", addr: "16660 Saddle Club Rd, Weston, FL 33326", lat: 26.11525, lon: -80.37574 },
    { name: "DL — Wewahitchka", addr: "151 N 3rd St, Wewahitchka, FL 32465", lat: 30.11399, lon: -85.19795 },
    { name: "DL — Wildwood", addr: "7375 Powell Rd, Wildwood, FL 34785", lat: 28.86381, lon: -82.01894 },
    { name: "DL — Williston", addr: "506 SW 1st Ave, Williston, FL 32696", lat: 29.38486, lon: -82.45401 },
    { name: "DL — Winter Haven", addr: "300 Ave M NW, Winter Haven, FL 33880", lat: 28.03448, lon: -81.72903 },
    { name: "DL — Winter Springs", addr: "1495 E State Rd 434, Winter Springs, FL 32708", lat: 28.68837, lon: -81.27347 },
  ],
};
